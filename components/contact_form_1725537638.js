<template>
  <main class="flex justify-center align-center p-10">
    <div class="w-fit max-w-lg p-8 bg-white shadow-lg rounded-lg">
      <div>
        <h3 class="text-black font-semibold text-xl">Discover Blockchain Insights</h3>
        <p class="mt-3 text-black w-fit">Stay ahead with the latest blockchain information</p>
      </div>
      <form @submit.prevent class="space-y-5 mt-5">
        ...
        <div>
          <label class="font-medium text-black">Preferred Blockchain (e.g., Bitcoin, Ethereum)</label>
        ...
        <div>
          <label class="font-medium text-black">Areas of Interest</label>
          <textarea
            required
  ...
  data() {
    return {
      ...
      servicesItems: [
        ...
        'New Project Alerts',
        'Custom Blockchain Notifications',
      ],
      countryCode: 'US',
    };
  },
